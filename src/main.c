...
unsigned char ASC_L = 0x00;
unsigned char ASC_H = 0x01;
unsigned char ASC_F = 0xFF;
...
void main()
{
    ...
    while (1)
    {
		...
		// 		// count循环累计
		// 		count = 0;
		// 		ledH = ((ledH == ASC_F) ? ASC_L : ASC_F);
		// 		ledL = ((ledL == ASC_L) ? ASC_F : ASC_L);
		// 		ledLight(ledH, ledL);
		// 		beenMusic();
		// 	}
		// }
